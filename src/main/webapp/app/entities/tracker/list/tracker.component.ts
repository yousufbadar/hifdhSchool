...
export class TrackerComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.trackerService
      ...
      .subscribe({
        next: (res: HttpResponse<ITracker[]>) => {
  ...
  trackId(index: number, item: ITracker): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITracker[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
